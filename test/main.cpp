...
int main_impl(int argc, char** argv, std::ostream& os) {
    ...
    aoc_2022::env::get_instance().set_resource_folder_path(fs::absolute(resource_folder_path));
